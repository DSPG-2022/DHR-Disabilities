...
(Difference between a persons age at the end of their case to the start of their case)
...
## How Long Cases Were Opened

```{r How Long Cases Were Opened, echo=FALSE}
months.opened <- IVRS %>%
...
(Unhelpful visually, hard to tell which number of months opened each bar is and when you set it to a factor the x labels are too crowded)

Sorted table shows number of months opened with highest number of cases.
...
Unhelpful visually, to many counties. (Note: Some clients are from outside of Iowa)
