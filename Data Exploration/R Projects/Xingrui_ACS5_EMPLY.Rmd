...
1.3 Total population with disabilities from EMPLOYMENT STATUS BY DISABILITY STATUS
```{r}
...
pop <- aggregate(estimate ~ NAME, data = pop, sum)
...
2.1 Population of Iowans 18-64 years with disabilities by age groups and difficulty types
```{r}
...
3.1 Population of Iowans 18-64 years with disabilities and without disabilities by race and ethnic
```{r}
...
3.2 Testing the reliability of RaceEthnic data
```{r}
