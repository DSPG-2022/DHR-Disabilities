...
```{r}
#all_emp_stat = all_emp_stat %>% mutate(percent_in_labor_force_employed_disabled = 100 * (all_emp_stat$disability_total/all_emp_stat$in_labor_force_employed_gap), percent_in_labor_force_employed_not_disabled = 100 * (all_emp_stat$no_disability_total/all_emp_stat$in_labor_force_employed_gap))

#all_emp_stat = all_emp_stat %>% mutate(percent_in_labor_force_unemployed_disabled = 100 * (all_emp_stat$disability_total/all_emp_stat$in_labor_force_unemployed_gap), percent_in_labor_force_unemployed_not_disabled = 100 * (all_emp_stat$no_disability_total/all_emp_stat$in_labor_force_unemployed_gap))

#all_emp_stat = all_emp_stat %>% mutate(percent_not_in_labor_force_disabled = 100 * (all_emp_stat$disability_total/all_emp_stat$not_in_labor_force_gap), percent_not_in_labor_force = 100 * (all_emp_stat$no_disability_total/all_emp_stat$not_in_labor_force_gap))
