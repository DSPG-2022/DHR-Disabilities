...
empl_status_disability= empl_status_disability %>% mutate(perc= 100* (estimate/sum(estimate))) 
View(empl_status_disability)
...
empl_status_no_disability= empl_status_no_disability %>% mutate(perc= 100* (estimate/sum(estimate))) 
View(empl_status_no_disability)
```
