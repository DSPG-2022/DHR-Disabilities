...
#Joining OASDI table to Metropolitan Table
...
mean(all_emp_stat$percent_in_labor_force_employed_disabled)
#mean(all_emp_stat$percent_in_labor_force_unemployed_disabled)

#merge SSI w Metro data

SSI_merge_Metro = merge(x = ssi_table, y = new_table, by = "GEOID", all.x = TRUE)

oasdi_amount_pop = merge(x = oasdi_amount_table, y = pop_table, by = "GEOID", all.x = TRUE)
```
...
write.csv(oasdi_metro_stat, "S:/misc/clg/DSPG2022/ProjectA/Sanika-oasdi_metro_stat.csv", row.names = FALSE)

write.csv(SSI_merge_Metro, "S:/misc/clg/DSPG2022/ProjectA/Sanika-SSI_metro_stat.csv", row.names = FALSE)

write.csv(oasdi_amount_pop, "S:/misc/clg/DSPG2022/ProjectA/Sanika-OASDI_amount_pop.csv", row.names = FALSE)
