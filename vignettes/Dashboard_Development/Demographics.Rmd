...
## The following code chucks are utilized for pulling demographic information from the ACS database built into (`tidycensus`)[https://walker-data.com/tidycensus/articles/basic-usage.html] and test reliability to provide neat data sources for further calculations and visualizations.
